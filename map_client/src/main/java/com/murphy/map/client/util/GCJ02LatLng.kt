...
fun gcj02ToBd09(lat: Double, lon: Double): DoubleArray {
    val z =
        sqrt(lon * lon + lat * lat) + 0.00002 * sin(lat * x_pi)
...
fun bd09ToGps84(lat: Double, lon: Double): DoubleArray? {
    val gcj02 = bd09ToGcj02(lat, lon)
    val gps84 = gcj02ToGps84(gcj02[0], gcj02[1])
    // 保留小数点后六位
